...
function Header() {
    ...
    return (
        <header className="header_container">
            <div className={burgerMenuOpen ? "header_burger-menu-page-cover" : "header_burger-menu-page-cover header_hide"}></div>
            <div className={burgerMenuOpen ? "header_burger-menu-content" : "header_burger-menu-content header_burger-menu-hide"}>
                <CategoryList onClick={() => setBurgerMenuOpen(false)} />
            </div>
